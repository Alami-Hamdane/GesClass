...
public class ListNiveles extends JFrame implements ActionListener {
	  ...
	  public ListNiveles(String nivel ){
			setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Worckspace2020\\GesClass2\\GesClass.jpg"));
			 ...
			 try {
			        ...
			        String query = "SELECT * FROM nivelestudios";
			    ...
			    label1=new JLabel("Lista de niveles disponibles" );
			    panel1=new JPanel();
			    panel2=new JPanel();
			  
			    columnas = new Vector<String>();
			    columnas.add("Nombre del nivel");
			    ...
			    for (int i=0;i<niveles.size();i++){
			        ...
			        Nivel niv = niveles.get(i);
			        
			        tuple.add(niv.getNombreNivel());
			        lineas.add(tuple);
			    }

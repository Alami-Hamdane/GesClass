...
public class ListaEstudiantes extends JFrame implements ActionListener {
	...
	public ListaEstudiantes(String consulta){
	    ...
	    try {
	        ...
	        while (rs.next()){
	         ...
	         //   e.setNivel(new Nivel(rs.getString("id_Nivel")));
	    ...
	    label1=new JLabel("Lista de todos los estudiantes del Centro");
	    panel1=new JPanel();
	    panel2=new JPanel();
	    ...
	    sl_panel2.putConstraint(SpringLayout.WEST, scrollPane, 32, SpringLayout.WEST, panel2);
	    sl_panel2.putConstraint(SpringLayout.SOUTH, scrollPane, 470, SpringLayout.NORTH, panel2);
	    sl_panel2.putConstraint(SpringLayout.EAST, scrollPane, -28, SpringLayout.EAST, panel2);
	    panel3=new JPanel();
